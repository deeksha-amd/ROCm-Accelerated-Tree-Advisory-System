...
For the root-level XGBoost POC, the filter stack is built by
`python satellite_rasters.py`: ESA WorldCover 10 m class maps, streamed as COG
overviews and averaged onto the shared 10-arc-minute grid. `recommend.py`
